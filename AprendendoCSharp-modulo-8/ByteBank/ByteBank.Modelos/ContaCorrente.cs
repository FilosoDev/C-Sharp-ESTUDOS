...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Exceção lançada qyando um valor negativo é utilizado no arguemtno <paramref name="valor"/>.</exception>
        ...
        /// <param name="valor"> Representa o valor do daque, deve ser maior que 0 e menor que o <see cref="Saldo"/>. </param>
        ...
        public override string ToString()
        {
            ...
            //return "Número: " + Numero + ", Agencia: " + Agencia + ", Saldo: " +
             //   "" + Saldo;
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            // Retornar 0 quando a instância e obj forem equivalentes;
            // Retornar positivo diferente de zero quando a preced~encia for de obj;
